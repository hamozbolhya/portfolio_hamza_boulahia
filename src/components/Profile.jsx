...
import ProjectsShowcase from "./profile/ProjectsShowcase";
    ...
    <section id="contact" class="relative py-20 md:py-28 overflow-hidden">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
              ...
              <div class="grid lg:grid-cols-3 gap-12 relative z-10">
                ...
                <div class="flex flex-col items-center">
                  ...
                  <div class="text-center mb-8">
                    ...
                    <p class="text-lg bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent font-semibold mb-4">
                      Full Stack Engineer
                    </p>
                    ...
                    <For each={socialLinks}>
                      {(social) => (
                        ...
                        >
                          ...
                          <span class="text-lg group-hover:scale-125 transition-transform duration-200">
                            {social.icon}
                          </span>
                        </a>
                      )}
                ...
                <div class="lg:col-span-2">
                  ...
                  <div class="mb-10">
                    ...
                    <p class="text-lg text-blue-100/90 leading-relaxed mb-6">
                      Senior React & React Native developer with extensive
                      expertise in Angular, Node.js, and Spring Boot.
                      Specialized in building enterprise-grade applications with
                      focus on performance, scalability, and user experience.
                    </p>
                    <p class="text-blue-100/80 leading-relaxed">
                      Master's degree holder in Big Data & Cloud Computing with
                      proven track record in banking, fintech, and retail
                      sectors. Passionate about AI integration, OCR
                      technologies, and architecting robust solutions.
                    </p>
                  </div>
                      ...
                      <For each={highlights}>
                        {(item) => (
                          <div class="group relative p-4 bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-blue-400/30 rounded-xl hover:from-blue-600/40 hover:to-purple-600/40 hover:border-blue-300/60 transition-all duration-200 cursor-default backdrop-blur-sm overflow-hidden">
                            ...
                            <p class="font-semibold text-white text-sm group-hover:text-blue-100 transition-colors">
                              {item.label}
                            </p>
                            <p class="text-xs text-blue-200/70 mt-1 group-hover:text-blue-200 transition-colors">
                              {item.description}
                            </p>
                          </div>
                        )}
          ...
          <div class="text-center mb-16" id="projects">
            <div class="inline-block mb-4">
              <div class="px-4 py-2 bg-blue-500/20 border border-blue-400/50 rounded-full backdrop-blur-sm">
                <p class="text-sm font-semibold text-blue-300">
