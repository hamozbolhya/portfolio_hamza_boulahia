...
export default function App() {
  ...
  return (
    <div class="relative min-h-screen overflow-x-hidden">
        ...
        <div class="relative z-10">
          ...
          >
            <div class="flex flex-col items-center gap-2">
              <div class="text-white text-sm font-semibold opacity-75">Scroll</div>
      ...
      <div class="fixed bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 z-50"
        style={{
      ...
      <style>{`
        * {
        ...
        @keyframes float {
          ...
          50% {
            transform: translate(${Math.random() * 200 - 100}px, ${Math.random() * -200}px);
            opacity: 0.8;
          }
          90% {
            opacity: 0.5;
